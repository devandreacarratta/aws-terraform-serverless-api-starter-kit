...
module "lambda_function_url_get_order" {
  source                 = "../infra-modules/lambda_function_url"
  lambda_function_name   = module.lambda_function_get_order.function_name_value
...
module "lambda_function_url_post_order" {
  source                 = "../infra-modules/lambda_function_url"
  lambda_function_name   = module.lambda_function_post_order.function_name_value
